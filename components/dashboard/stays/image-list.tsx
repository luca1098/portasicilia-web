...
import { reorderStayImagesAction } from '@/lib/actions/stay-images.actions'
...
export default function ImageList({ stayId, images }: ImageListProps) {
  ...
  const handleSaveOrder = () => {
    ...
    if (!payload) return
    execute(() => reorderStayImagesAction(stayId, payload))
  }
